  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), function (results) {
        _this.resultsDiv.html("\n        <div class=\"row\">\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">General Information</h2>\n            ".concat(results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>Sorry! No general information matches your search.</p>', "\n              ").concat(results.generalInfo.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a> ").concat(item.postType == 'post' ? "by ".concat(item.authorName) : '', "</li>");
        }).join(''), "\n            ").concat(results.generalInfo.length ? '</ul>' : '', "\n          </div>\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Programs</h2>\n            ").concat(results.programs.length ? '<ul class="link-list min-list">' : "<p>Sorry! No programs match your search. <a href=\"".concat(universityData.root_url, "/programs\">View all Programs</a></p>"), "\n              ").concat(results.programs.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n            ").concat(results.programs.length ? '</ul>' : '', "\n            \n            <h2 class=\"search-overlay__section-title\">Professors</h2>\n            ").concat(results.professors.length ? '<ul class="professor-cards">' : "<p>Sorry! No professors match your search. <a href=\"".concat(universityData.root_url, "/programs\">View all Programs</a></p>"), "\n              ").concat(results.professors.map(function (item) {
        ...
        }).join(''), "\n            ").concat(results.professors.length ? '</ul>' : '', "\n            \n          </div>\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Campuses</h2>\n            ").concat(results.campuses.length ? '<ul class="link-list min-list">' : "<p>Sorry! No campuses match your search. <a href=\"".concat(universityData.root_url, "/campuses\">View all Campuses</a></p>"), "\n              ").concat(results.campuses.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n            ").concat(results.campuses.length ? '</ul>' : '', "\n\n            <h2 class=\"search-overlay__section-title\">Events</h2>\n            ").concat(results.events.length ? '' : "<p>Sorry! No events match your search. <a href=\"".concat(universityData.root_url, "/events\">View all Events</a></p>"), "\n            ").concat(results.events.map(function (item) {
